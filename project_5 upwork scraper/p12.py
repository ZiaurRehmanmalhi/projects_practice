...
def scrape_freelancers_data():
    ...
    for name, role, profile_link, country, hourly_rate, total_earned, job_success_score, badge, bio, company_name, company_earn, raw_html, company_link in zip(
            names, roles, profile_links, countries, hourly_rates, total_earneds, job_success_scores, badges, bios,
            company_names, company_earns, raw_htmls, company_links):
